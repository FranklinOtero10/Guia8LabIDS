...
class EstudiantesController extends CI_Controller
{
    ...
    public function add()
    {
        ...
        $this->form_validation->set_rules("idestudiante", "Id Estudiante", "required|min_length[1]|max_length[12]|is_unique[estudiantes.idestudiante]");
    ...
    public function update()
    {
        ...
        valid_email: indica que el valor debe ser un correo con formato válido.
         */
        $this->form_validation->set_rules("idestudiante", "Id Estudiante", "required|min_length[1]|max_length[12]");
        $this->form_validation->set_rules("nombre", "Nombre", "required|max_length[100]");
        $this->form_validation->set_rules("apellido", "Apellido", "required|max_length[100]");
